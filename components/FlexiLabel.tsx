    ...
    <div className="flex flex-col w-[80mm] h-[60mm] bg-white text-black font-mono overflow-hidden relative border-black box-border">
            ...
            <div className="flex-1 flex flex-col relative z-10 bg-transparent px-3 py-1.5 min-h-0">
                ...
                <div className="flex flex-col flex-1 min-h-0">
                    ...
                    <div className="flex items-baseline gap-2 shrink-0 mb-1 border-b border-black/5 pb-0.5">
                        <SmartText isDesignMode={isDesignMode} initialValue={data.name} baseSize={11} bold font="mono" />
                        <span className="text-black/20 text-[8pt]">|</span>
                        <SmartText isDesignMode={isDesignMode} initialValue={data.phone} baseSize={12} bold font="mono" />
                    </div>
                    
                    {/* Destination & Address Detail Combined Flow */}
                    <div className="flex-1 overflow-hidden pt-0.5">
                        <span className="text-[5pt] font-black opacity-40 uppercase block leading-none mb-1">Shipping Destination</span>
                        <div className="leading-snug">
                            {/* Location (Province) followed by Address Detail */}
                            <SmartText isDesignMode={isDesignMode} initialValue={data.location} baseSize={13.5} bold font="mono" className="mr-2 text-brand-black" />
                            <SmartText isDesignMode={isDesignMode} initialValue={data.address} baseSize={9} font="mono" className="opacity-90 italic" />
                        </div>
                    </div>
                </div>
            </div>
